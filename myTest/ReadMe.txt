================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : myTest Project Overview
===============================================================================

The application wizard has created this myTest application for
...
myTestDlg.h, myTestDlg.cpp - the dialog
    ...
    in myTest.rc, which can be edited in Microsoft Visual C++.
